...
TEST_CASE("allergic_to_lots_of_stuff") {
  ...
  const std::unordered_set<std::string> lots_of_stuff = {
...
TEST_CASE("allergic_to_everything") {
  ...
  const std::unordered_set<std::string> everything = {"eggs",
                                                      "peanuts",
                                                      "shellfish",
                                                      "strawberries",
                                                      "tomatoes",
...
TEST_CASE("ignore_non_allergen_score_parts") {
  ...
  const std::unordered_set<std::string> non_allergen = {"eggs",
                                                        "shellfish",
                                                        "strawberries",
                                                        "tomatoes",
                                                        "chocolate",
